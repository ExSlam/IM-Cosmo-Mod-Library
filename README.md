...
- [Mod Localization System](mods/Mod%20Localization%20System/README.md) - Shared language-aware JSON runtime plus the source embedded by localized Cosmo mods for dependency-free UI translation fallback.
...
- [Monthly Ledger](mods/Monthly%20Ledger/README.md) - Action Hub monthly income and expense history powered by IM Data Core.
