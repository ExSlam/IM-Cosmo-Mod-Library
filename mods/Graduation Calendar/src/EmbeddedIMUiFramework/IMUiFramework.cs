...
{
    // Embedded build: framework-global Harmony patches are intentionally omitted.
    // The host mod initializes IMUiKit from its own PopupManager.Start patch, avoiding
    // duplicate framework patches if the standalone IM UI Framework is also installed.
