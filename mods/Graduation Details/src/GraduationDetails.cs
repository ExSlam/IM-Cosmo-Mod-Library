...
namespace GraduationDetails
{
    ...
    internal static class MarriageRecordStore
    {
        internal static MarriageRecord GetRecord(int girlId)
        {
            ...
            if (GraduationDetailsPersistenceController.TryGetMarriageRecord(
                    girlId,
                    out record))
            {
                return record;
        ...
        internal static void Upsert(MarriageRecord record)
        {
            ...
            GraduationDetailsPersistenceController.UpsertMarriageRecord(record);
        }
    }
    ...
    internal static class StaffIdolStore
    {
        ...
        {
            return GraduationDetailsPersistenceController.TryGetStaffIdolRecord(
                staffId,
                out record);
        }
        ...
        internal static bool TryResolveStaffer(staff._staff staffer, out int girlId)
        {
            ...
            if (TryGetRecord(staffer.id, out record))
            {
                ...
                GraduationDetailsPersistenceController.RemoveStaffIdolRecord(
                    staffer.id);
                girlId = -1;
            }
        ...
        private static void Upsert(staff._staff staffer, int staffId, int girlId, bool capturedAtHire)
        {
            ...
            StaffIdolRecord record;
            if (!TryGetRecord(staffId, out record) || record == null)
            {
            ...
            GraduationDetailsPersistenceController.UpsertStaffIdolRecord(record);
        }
    ...
    internal static class GraduationSnapshotStore
    {
        internal static GraduationSnapshot GetSnapshot(int girlId)
        {
            ...
            if (GraduationDetailsPersistenceController.TryGetGraduationSnapshot(
                    girlId,
                    out record))
            {
                return record;
        ...
        internal static string GetPortraitPath(GraduationSnapshot snapshot)
        {
            ...
            return GraduationDetailsPersistenceController.GetPortraitReadPath(
        ...
        private static void Upsert(GraduationSnapshot snapshot)
        {
            ...
            GraduationDetailsPersistenceController.UpsertGraduationSnapshot(
                snapshot);
        }
        ...
        private static void TryCapturePortrait(data_girls.girls girl, GraduationSnapshot snapshot)
        {
            ...
            if (!string.IsNullOrEmpty(readablePath) && File.Exists(readablePath))
            {
                return;
            }
            string destPath = snapshot == null
                ? ""
                : GraduationDetailsPersistenceController.GetPortraitCapturePath(
                    snapshot.PortraitFile);
        ...
        {
            GraduationDetailsPersistenceController.TryStagePortrait(
                sourcePath,
                destPath);
        }
